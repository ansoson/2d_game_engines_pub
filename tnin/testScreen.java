...
import engine.mapTools.XMLReader;
...
public class testScreen extends Screen {
    ...
    int Waiting = 0;
    public testScreen(String title, Vec2d windowSize, Double gameDimensions) throws IOException, ParserConfigurationException, SAXException {
        ...
        SpritesLoaded = false;
        XMLReader saver = new XMLReader("engine/mapTools/TestMap.xml", this);
        saver.readXML();
