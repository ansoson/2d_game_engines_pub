...
public class Level2Screen extends Screen {
    public Level2Screen(String title, Vec2d windowSize, Double gameDimensions) {
        ...
        ArrayList<Tile> map = new WizGenerator().GenerateMap(new Level2(), gameManager);
        new SituationalTileIndexer().indexTiles(new Level2(), map);
        for (Tile tile: map){
            tile.situationalize();
        }
    }
